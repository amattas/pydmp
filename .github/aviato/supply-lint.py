...
# aviato:hash=0ea36c9bcac86d94da27df5ea1a7c05d92ce67c12201fae89d9366c18bf72fb0
...
_INTERPRETER = r"(?<![\w.-])(?i:sh|bash|zsh|ksh|dash|ash|fish|csh|tcsh|python[0-9.]*|ruby|perl|node|nodejs|php|pwsh)\b"
...
_CMD_PREFIX = rf"(?:[A-Za-z_][A-Za-z0-9_]*=[^\s;|&]*[ \t]+)*(?:{_PREFIX_WORD}[ \t]+(?:{_PREFIX_OPERAND}[ \t]+)*)*"
